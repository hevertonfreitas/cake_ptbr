...
class AjusteDataBehaviorTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Noticias = $tableLocator->get('CakePtbr.Noticias');
    }
    ...
    public function testDeteccaoAutomatica()
    {
        ...
        $this->assertEquals('datetime', $this->Noticias->getSchema()->getColumnType('publicado_em'));
    ...
    private function __preparaNoticia($publicadoEm = false, $autorizadoEm = false)
    {
        ...
        $this->assertEmpty($noticia->getErrors());
